...
> Conversation Turns require daemon capability `delivery-admission-v1`, and settled agent
> lifecycle controls require `agent-control-ack-v1` (both daemon 0.12.0+).
